...
class 이체내역 {
    ...
    private int senderNumber; // 보내는 분의 계좌
    private String receiver; // 받는 분
    private int receiverNumber; // 보내는 분의 계좌
    private int money; // 받는 분의 계좌
...
public class StringEx01 {
    public static void main(String[] args) {
        ...
        // class 에 옮겨야 하나로 관리가 가능하기 때문에 편하다.
        String sender = tokens[0];
        int senderNumber = Integer.parseInt(tokens[1]); // 토큰을 int로
